...
public class Chinhsuabaiviet extends AppCompatActivity {
        ...
        callback.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (mess.equals("success")) {
                    startActivity(new Intent(Chinhsuabaiviet.this,Trangchu.class));
                }
            }
            @Override
    ...
    private void getData() {
        ...
        String username=Trangchu.mUser.getDisplayName();
        String avt= String.valueOf(Trangchu.mUser.getPhotoUrl());
        edt_noidung.setText(noidung);
        Picasso.with(Chinhsuabaiviet.this).load(hinhanhbaiviet)
                .placeholder(R.drawable.ic_image_black_24dp)
                .error(R.drawable.ic_broken_image_black_24dp)
                .into(img_hinhanhbaiviet);
        Picasso.with(Chinhsuabaiviet.this).load(avt)
                .placeholder(R.drawable.ic_image_black_24dp)
                .error(R.drawable.ic_broken_image_black_24dp)
                .into(img_avt);

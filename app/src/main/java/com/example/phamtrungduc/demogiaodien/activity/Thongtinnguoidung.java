...
public class Thongtinnguoidung extends AppCompatActivity {
    ...
    private void getData() {
        old_avt= String.valueOf(Trangchu.mUser.getPhotoUrl());
        String email=Trangchu.mUser.getEmail();
//        edt_email.setText(email);
    ...
    private void getThongtinnguoidung(String email) {
        ...
        Call<List<Nguoidung>> callback= dataClient.get_nguoidung(email.trim());
        callback.enqueue(new Callback<List<Nguoidung>>() {
            ...
            public void onResponse(Call<List<Nguoidung>> call, Response<List<Nguoidung>> response) {
                List<Nguoidung> thongtinnguoidung=response.body();
                ...
                try {
                    Picasso.with(Thongtinnguoidung.this).load(thongtinnguoidung.get(0).getAnhdaidien())
    ...
    private void EventClick() {
        ...
        tv_changeavt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Thongtinnguoidung.this, READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    Intent intent = new Intent(Intent.ACTION_PICK);
                    intent.setType("image/*");
                    startActivityForResult(intent, REQUEST_CODE_IMAGE);
                } else {
                    ActivityCompat.requestPermissions(Thongtinnguoidung.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
                }
            }
        });
...
//            Toast.makeText(this, real_path, Toast.LENGTH_SHORT).show();
    ...
    private void UpdateFirebase2(String username) {
        UserProfileChangeRequest request=new UserProfileChangeRequest.Builder()
                ...
                .build();
        Trangchu.mUser.updateProfile(request).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                pro_thongtin.setVisibility(GONE);
                btn_save.setVisibility(View.VISIBLE);
//                Toast.makeText(Thongtinnguoidung.this, "Cập nhật fb thành công", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Thongtinnguoidung.this,Trangchu.class));
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Thongtinnguoidung.this, "Cập nhật thất bại", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void UpdateFirebase1(String username, String new_avt) {
            ...
            Trangchu.mUser.updateProfile(request).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Thongtinnguoidung.this, "Cập nhật fb thất bại", Toast.LENGTH_SHORT).show();
